...
class TestLargesTwoNumbers < Test::Unit::TestCase
	...
	def test_empty
		...
		assert_raise RuntimeError do
			returned_result = largest_two_numbers.get_largest_two_numbers(numbers)	
		end		
	end
	...
	def test_normal_array
		...
		largest_two_numbers = LargestTwoNumbers.new
		numbers = Array[5,7,9,10,1000,9999,55,12,-50,15000]
	...
	def test_with_duplicates
		...
		largest_two_numbers = LargestTwoNumbers.new
		numbers = Array[5.9,10,12,10,78,78]
		
		returned_result = largest_two_numbers.get_largest_two_numbers(numbers)		
		
		assert_equal(Array[78,78], returned_result)
	end
